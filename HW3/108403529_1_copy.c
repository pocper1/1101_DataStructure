...
void Huffman()
{
    ...
    while (1)
    {
        ...
        parent->character = huffman[0].character + huffman[1].character;
...
void findNodes(struct node *ro)
{
    printf("in function want to find:\n");
    array0[1] = '\0';
    array1[1] = '\0';
    ...
    if (ro->leftChild)
    {
        ...
        findNodes(ro->leftChild);
        
        
    }
    if (ro->character >= 'a' && ro->character <= 'z') {
      printf("%c tmp_char: %s\n", ro->character, tmp_char);
      *
    }
